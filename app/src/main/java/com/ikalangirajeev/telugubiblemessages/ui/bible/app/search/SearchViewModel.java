...
public class SearchViewModel extends AndroidViewModel {
    ...
    public LiveData<List<SearchData>> getSearchDataList(String selectedBible, String searchableString) {
    ...
    private static class MyAsyncTask extends AsyncTask<String, Void, List<SearchData>> {
        ...
        String searchableString, bibleSelected;
        ...
        protected List<SearchData> doInBackground(String... strings) {
            ...
            searchDataList.clear();
            bibleSelected = strings[0];
            searchableString = strings[1];
            ...
            if(bibleSelected.equals("bible_english")){
                ...
                List<EnglishBible> englishBibleList = englishBibleDao.getQueriedBibleList(searchableString);
                for (EnglishBible verse : englishBibleList){
                    SearchData data = new SearchData(englishBooks[verse.getBook()] + " " +
                            verse.getChapter() + ":" + verse.getVersecount(), verse.getVerse()
                    , englishBooks[verse.getBook()],verse.getBook(), verse.getChapter(), verse.getVersecount());
                ...
                List<TamilBible> tamilBibleList = tamilBibleDao.getQueriedBibleList(searchableString);
                for (TamilBible verse : tamilBibleList){
                    SearchData data = new SearchData(tamilBooks[verse.getBook()] + " " +
                            verse.getChapter() + ":" + verse.getVersecount(), verse.getVerse()
                            , tamilBooks[verse.getBook()],verse.getBook(), verse.getChapter(), verse.getVersecount());
                    searchDataList.add(data);
                }
                return searchDataList;
                ...
                List<KannadaBible> kannadaBibleList = kannadaBibleDao.getQueriedBibleList(searchableString);
                for (KannadaBible verse : kannadaBibleList){
                    SearchData data = new SearchData(kannadaBooks[verse.getBook()] + " " +
                            verse.getChapter() + ":" + verse.getVersecount(), verse.getVerse()
                            , kannadaBooks[verse.getBook()],verse.getBook(), verse.getChapter(), verse.getVersecount());
                    searchDataList.add(data);
                }
                return searchDataList;
                ...
                List<HindiBible> kannadaBibleList = hindiBibleDao.getQueriedBibleList(searchableString);
                for (HindiBible verse : kannadaBibleList){
                    SearchData data = new SearchData(hindiBooks[verse.getBook()] + " " +
                            verse.getChapter() + ":" + verse.getVersecount(), verse.getVerse()
                            , hindiBooks[verse.getBook()],verse.getBook(), verse.getChapter(), verse.getVersecount());
                    searchDataList.add(data);
                }
                return searchDataList;
                ...
                List<MalayalamBible> malayalamBibleList = malayalamBibleDao.getQueriedBibleList(searchableString);
                for (MalayalamBible verse : malayalamBibleList){
                    SearchData data = new SearchData(malayalamBooks[verse.getBook()] + " " +
                            verse.getChapter() + ":" + verse.getVersecount(), verse.getVerse()
                            , malayalamBooks[verse.getBook()],verse.getBook(), verse.getChapter(), verse.getVersecount());
                    searchDataList.add(data);
                }
                return searchDataList;
            } else {
                ...
                List<TeluguBible> teluguBibleList = teluguBibleDao.getQueriedBibleList(searchableString);
                for (TeluguBible verse : teluguBibleList) {
                    SearchData data = new SearchData(teluguBooks[verse.getBook()] + " " +
                            verse.getChapter() + ":" + verse.getVersecount(), verse.getVerse()
                            , teluguBooks[verse.getBook()],verse.getBook(), verse.getChapter(), verse.getVersecount());
                    searchDataList.add(data);
                }
                return searchDataList;
            }
